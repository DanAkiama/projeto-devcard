...
**Screenshot:**
![DevCard Welcome Screen](assets/images/icon.png)
...
**Screenshot:**
![DevCard Registration Screen](assets/images/icon.png)
...
**Screenshot:**
![DevCard Preview Screen](assets/images/icon.png)
...
**Screenshot:**
![DevCard Success Screen](assets/images/icon.png)
